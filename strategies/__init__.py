...
# risk_pct: 每笔风险仓位(与实盘口径一致); 趋势系统改为 8% 跟踪止损 + 每笔2%风险。
STRATEGY_EXTRA = {
    "buy_hold": {},
    "sma_48_336": {"stop_pct": 0.15, "risk_pct": 0.01},
    "trend_1440": {"stop_pct": 0.15, "risk_pct": 0.01},
    "trend_system_48_336_1440": {"stop_pct": 0.15, "trail_pct": 0.08, "risk_pct": 0.02},
}